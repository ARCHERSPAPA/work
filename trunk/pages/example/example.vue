  ...
  <view class="example">
    ...
    <view class="example-wrap">
      <view v-if="isComplete" class="example-info-done">
        ...
        <view class="example-info-address" @tap="openShopLocation(exampleInfo)">{{ exampleInfo.customerGpsAddress?exampleInfo.customerGpsAddress:'' }}</view>
        ...
        <view v-if="isComplete" class="example-head">
          ...
          <view class="example-head-info">
            <text class="example-head-person">
              <text style="opacity: 0.9;color: #000; margin-right: 21.73rpx;">{{ memberInfo.name?memberInfo.name:'' }}</text>
              <text style="font-size: 21.73rpx;color: #000;padding: 3.62rpx 7.24rpx;box-sizing: border-box;border-radius:7.24rpx;background: rgba(0,0,0,0.03);color: rgba(0,0,0,0.70);">{{ memberInfo.position?memberInfo.position:'' }}</text>

            </text>
            <text class="example-head-company">{{ memberInfo.companyName?memberInfo.companyName:'' }}</text>
...
export default {
  ...
  onLoad(option) {
    this.quoteId = option.quoteId || this.getQueryString('quoteId', decodeURIComponent(option.scene)) || this.$parseURL()
      .quoteId
    this.nature = option.nature || this.getQueryString('nature', decodeURIComponent(option.scene)) || this.$parseURL().nature
	this.qrImg = null;
  ...
  methods: {
    ...
    renderPoster() {
      sharePoster({
        ...
        // coverImg:"https://tqiniu.madrock.com.cn/rev/case/TEST/4608/31ed9786-a9c3-9128-c312-89b557653c89.jpg",
        // coverImg: "https://tqiniu.madrock.com.cn/rev/case/TEST/2640/9ec0e7d9-f3f1-960f-c924-eaa044e5c3a7.jpg",
