<script>
	...
	export default {
      ...
      isSdkReady() {
      	return this.$store.state.global.isSdkReady
      }
		},
...
<style lang="scss">
	...
	.integral-tag-bar {
		...
		color: #ffffff;
		border-radius: 4upx;
		// background-color: $bg-color-activity;
	...
	.sanjiao-down {
		border-color: $font-color-base transparent transparent transparent;
	}

	.sanjiao-up {
		border-color: transparent transparent $font-color-base transparent;
	}
	...
	.sanjiao-right {
		...
		border-style: solid dashed dashed dashed;
		/*IE6下, 设置余下三条边的border-style为dashed,即可达到透明的效果*/
		border-color: transparent transparent transparent $bg-color-base;
	}
