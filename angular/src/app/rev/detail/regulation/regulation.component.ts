...
export class RegulationComponent implements OnInit {
    ...
    ngAfterContentChecked() {
        ...
        if(this.reg.getTypeByParam("change")){
            ...
            this.regularsEmitter.emit({list:this.list});
        }
    ...
    showAuditBtnByState() {
        // if(this.list && this.list.pause){
        // console.log(this.getLastHistoryByParam("state"));
        return showAuditBtnByState(this.getLastHistoryByParam("state")) && this.state === 5 && this.baseQuote && this.baseQuote.retreat === 0 && this.getLastHistoryByParam("type") === 0;
        // }
        // return false;
    }
