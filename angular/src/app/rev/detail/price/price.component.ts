...
export class PriceComponent implements OnInit {
     ...
     */
    showSubmitByState(){
        return (showBtnByState(this.baseQuote)) && equalToSame(this.user.getPhone(), this.designers) && this.state !== Default.STATE.ITEM_6 && this.baseQuote.retreat === 0 && this.baseQuote && this.baseQuote.confirmState === 0;
    }
