...
@Component({
  selector: 'rev-item-details-pack',
  templateUrl: './item-details-pack.component.html',
  styleUrls: ['./../../../rev/master/master-promotion-detail/master-promotion-detail.component.scss','./item-details-pack.component.scss']
})
export class ItemDetailsPackComponent implements OnInit {
    ...
    constructor(private masterPack:MasterPackService,
