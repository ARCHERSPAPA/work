...
export class MasterCommonPackComponent implements OnInit {
    ...
    //销售价
    public packSalePrice:number = null;
    //供货价
    public packSupplyPrice:number = null;
    //活动价
    public packActivityPrice:number = null;
    //开始时间
    public startTime: Date;
    //结束时间
    public endTime: Date;
    //是否拆分
    public separable:string = '1';
    //备注
    ...
    ngOnChanges(changes:SimpleChanges){
        if(changes.form && changes.form.currentValue){
            ...
            this.separable = String(values["separable"]);
