...
@Component({
    selector: 'rev-temp-meal-base-list',
    templateUrl: './temp-meal-base-list.component.html',
    styleUrls: ['./temp-meal-base-list.component.scss']
})
export class TempMealBaseListComponent implements OnInit {
